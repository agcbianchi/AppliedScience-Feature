...
def ClassificacaoHierarquica(X_train, y_train, X_test, y_test, opcao_dataset, nome_classificador, op):
    ...
    if (opcao_dataset == 3):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF = RandomForest(X_train_balanceado, y_train_balanceado, X_test, y_test)
        ...
        if(op == "sem_bal"):
            print(precisao, revocacao, f1, acuracia, especificidade)
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_na = RandomForest(X_train_na_balanceado, y_train_na_balanceado, X_test, y_test2classes)
        if(nome_classificador == "DT"):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_alterada3 = RandomForest(X_train_alterada_bal, y_train_alterada_bal, X_test_alterada, y_test_alterada3classes)
        if(nome_classificador == "DT"):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_madura = RandomForest(X_train_madura_bal, y_train_madura_bal, X_test_madura, y_test_madura)
        if(nome_classificador == "DT"):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_jovem = RandomForest(X_train_jovem_bal, y_train_jovem_bal, X_test_jovem, y_test_jovem)
        if(nome_classificador == "DT"):
    ...
    if (opcao_dataset == 7):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_alterada = RandomForest(X_train_alterada_bal, y_train_alterada_bal, X_test_alterada, y_test_alterada)
        if(nome_classificador == "DT"):
        ...
        if(nome_classificador == "RF"):
            precisao, revocacao, f1, acuracia, especificidade, y_predRF_normal = RandomForest(X_train_normal_bal, y_train_normal_bal, X_test_normal, y_test_normal)
        if(nome_classificador == "DT"):
...
if (opcao_dataset == 3):
    dataset = pd.read_csv('cric-extracted-features.csv')   
    X = dataset.iloc[:, 231:232].values
    y = dataset.iloc[:, 235].values  
if (opcao_dataset == 7): #herlev 
    dataset = pd.read_csv('herlev-extracted-features.csv')   
